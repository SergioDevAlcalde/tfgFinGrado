...
public class HomeController {
    ...
    @Autowired
    private OrdenDetalleController detalleControl;
    @Autowired
    ...
    public String agregoEnCarro(@PathVariable("id") Long id, @Valid Cantidad cantidad) {

        System.out.println("el pedido recibido: "+cantidad);
    ...
    @RequestMapping(value = "/productoUnico")
